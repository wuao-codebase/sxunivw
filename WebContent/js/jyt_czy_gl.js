    	  ...
    	  $.ajax({
    	    	...
    	    	success: function (data) {
    		        ...
    		        for (var i = 0; i < data.length; i++) {
    		            $('.selectpicker').append("<option value=" + data[i].xxdm + ">" + data[i].xxxm + "</option>");
    		        }
    		        $('#txt_xxxm1').selectpicker('refresh');
    		        $('#txt_xxxm1').selectpicker('render');
    	    }
    	});
