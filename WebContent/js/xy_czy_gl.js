...
//    		        positionClass: "toast-top-center",  
    	            ...
    	            var arrselections = $("#tb_departments").bootstrapTable('getSelections');
    	             ...
    	             Ewin.confirm({ message: "确认要删除选择的数据吗？" }).on(function (e) {
    	                 ...
    	                 $.ajax({
    	                     ...
    	                     url:"/sxunivw/Xyczygl",
    	                     data: {                     	
    	                     	"czylb":arrselections[0].czylb,
    	                     	"czyzgh":arrselections[0].czyzgh,
    	                     	"id":3
    	                     },
    	        ...
    	        var bootstrapValidator = $("#defaultForm1").data('bootstrapValidator');
         	        ...
         	        if(bootstrapValidator.isValid()){
         	        	var zyidxlsh = $("#txt_zyxm").val();
        	            var lxr = $("#txt_lxr").val();
        	            var lxdh = $("#txt_lxdh").val();
        	            var zylb = $("#txt_zylb").val();
        	            if (zyidxlsh == null || zyidxlsh == undefined || zyidxlsh == '') {
