...
<link rel="stylesheet" href="css/ladda-themeless.min.css">
  ...
  <body>
		                ...
		                <!--        You can switch " data-color="green" "  with one of the next bright colors: "bue", "azure", "orange", "red"       -->
								...
								<div class="wizard-navigation">
									...
									<ul>
			                            ...
			                            <li>
											<a style="pointer-events: none;" href="#tab3" data-toggle="tab">
												<div class="icon-circle">
													<i class="ti-panel"></i>
												</div>
												师资
			                            ...
			                            <li>
											<a style="pointer-events: none;" href="#tab4" data-toggle="tab">
												<div class="icon-circle">
													<i class="ti-user"></i>
												</div>
												科学研究
										...
										<li>
											<a style="pointer-events: none;" href="#tab6" data-toggle="tab">
												<div class="icon-circle">
													<i class="ti-map"></i>
												</div>
												教学改革
										...
										<li>
											<a style="pointer-events: none;" href="#tab7" data-toggle="tab">
												<div class="icon-circle">
										...
										<li>
											<a style="pointer-events: none;" href="#tab8" data-toggle="tab">
												<div class="icon-circle">
		                        ...
		                        <div class="tab-content">
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text" digits="1" value="0" maxlength="2" class="form-control" name="CXFAXMS" required/>
				                            </div>
				                        </div>
				                        <div class="group">
				                    ...
				                    <div class="form-group">
				                     ...
				                     <div class="form-group">
				                        ...
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                                <input  type="text" digits="1" value="0" max="600" maxlength="3" class="form-control" name="ZCRS" required/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text" digits="1" value="0" maxlength="4" class="form-control" name="GJJNJSCJRS" required/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年参加省级技能竞赛人数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text" digits="1" digits="1" value="0" maxlength="4" max="3000" class="form-control" name="SXJNJSCJRS" data-toggle="tooltip" data-placement="top" title="不含互联网+大赛" required/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text" digits="1" value="0" maxlength="4" class="form-control" name="GJJNJSDJS" required/>
				                            </div>
				                        </div>
				                        <div class="group">
				                    ...
				                    <div class="form-group">
				                      ...
				                      <div class="form-group">
		                               ...
		                               <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <div class="input-group">
											      <input type="text" class="form-control" name="YINGYUA" maxlength="5" max="100"  minNumber="1" value="0"  required>
											      <div class="input-group-addon">%</div>
											    </div>
				                            </div>
				                        </div>
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                            	<div class="input-group">
											      <input type="text" class="form-control" name="YINGYUB" maxlength="5" max="100"  minNumber="1" value="0" required>
											      <div class="input-group-addon">%</div>
											    </div>
				                            </div>
				                        </div>      	
 									...
 									<div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text" digits="1" value="0" class="form-control" name="ZYZSHQL" maxlength="4" max="2000"  data-toggle="tooltip" data-placement="top" title="不含学科竞赛获奖" required/>
				                            </div>
				                        </div>
				                    </div>  
				                    <div class="form-group">
		                         ...
		                         <div class="tab-pane" id="tab3">
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <div class="input-group">
		 										<input type="text" class="form-control" name="ZYTUSHU"  value="0" digits="1"  maxlength="7"  data-toggle="tooltip" data-placement="top" title="含纸质、电子图书" required>
				                    ...
				                    <div class="form-group">
				                        ...
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
											      <div class="input-group">
											      <input type="text" class="form-control" name="BYLWBL" maxlength="5" max="100"  minNumber="1" value="0" required>
											      <div class="input-group-addon">%</div>
											    </div>
				                            </div>
				                        </div>      	
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"   maxlength="4" type="text" class="form-control" name="DNDDBXSS" required>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">当年现代学徒学生数量:</label>
				                            <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="4" type="text" class="form-control" name="DNXDXTS" required>
				                            </div>
				                        </div>      	
				                    </div> 
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="GJJXNZSS" required>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">省级虚拟仿真实验教学中心数量:</label>
				                            <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="SJXNZSS" required>
				                            </div>
				                        </div>      	
				                    </div> 
				                     <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="XQLHPYXYS" required>
				                            </div>
				                        </div>
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="GJJSYSS" required>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">省级实验室数量:</label>
				                            <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="SJSYSS" required>
				                            </div>
				                        </div>      	
				                    </div> 
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="GJJSCSXJDS" required>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">省级生产性实训基地数:</label>
				                            <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="SJSCSXJDS" required>
				                            </div>
				                        </div>      	
				                    </div> 
				                   <div class="form-group">
				                    ...
				                    <div class="form-group">
		                             ...
		                             <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="DNSJJXYJS" required>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">国家级精品课程数量:</label>
				                            <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="DNGJJJPKCS" data-toggle="tooltip" data-placement="top" title="视频公开课、资源共享课、慕课" required>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="DNSJJPKCS" data-toggle="tooltip" data-placement="top" title="视频公开课、资源共享课、慕课" required>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">教师获得国家级教学成果奖累计数:</label>
				                            <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="DNSJJXCGJS" required>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="SJRCPYSYCS" required>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="DNJGLWS" required>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">当年教师以学校为第一单位，公开出版国家级规划教材:</label>
				                            <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="DNGJJJCS" required>
				                            </div>
				                        </div>      	
				                    </div>
				                     <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="DNSJYXJCS" required>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">其他教材第一主编公开出版:</label>
				                            <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="DNQTJCS" required>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="DNGJJJXCGJ" required>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">当年省级教学成果奖:</label>
				                            <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="DNSJJJXCGJ" required>
				                            </div>
				                        </div>      	
				                    </div>
		                            </div>
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="CYZDJSRS" data-toggle="tooltip" data-placement="top" title="统计专职与兼职双创导师人数" required>
				                            </div>
				                        </div>
				          				<div class="group">
				                            <label class="col-sm-2 control-label">当年教师到企业进行3个月以上挂职锻炼的人数:</label>
				                           <div class="col-sm-3">
											      <input digits="1" value="0"  maxlength="2" type="text" class="form-control" name="GZRS" required>
				                            </div>
				                        </div>
				                    </div>
	...
	<script src="js/zkzyxxup.js" type="text/javascript"></script>
