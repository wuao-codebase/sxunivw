		            ...
		            <div class="wizard-container">
		                ...
		                <div class="form-group">
				                        <div class="group ">
				                            ...
				                            <div class="col-sm-2">
				                                <select id='txt_zylb' OnChange="zylb()" class="form-control"  readonly >
				                        ...
				                        <div class="group">
				                            ...
				                            <button type="button" onclick="find()" class="btn btn-default">查 询</button>
				                        </div> 
				                    </div>
				            </form>
		                        ...
		                        <div class="tab-content">
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                                <input  type="text"   class="form-control" name="" placeholder="本科" readonly/>
				                            </div>
				                        </div>
				                        <div class="group">
...
<div class="form-group">
	...
	<script src="js/xy-zyxxexport.js" type="text/javascript"></script>
