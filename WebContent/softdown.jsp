		            ...
		            <div class="wizard-container">
		                ...
		                <!--        You can switch " data-color="green" "  with one of the next bright colors: "bue", "azure", "orange", "red"       -->
		                    	...
		                    	<div class="wizard-header">
		                        	<h3 class="wizard-title" style="color:#F00;font-size:30px;">软件下载</h3>
		                    	</div>
		                        ...
		                        <div class="tab-content" style="text-align:left;font-size:25px;">
		                         ...
		                         <h>&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;陕西省专业普查大数据报送系统推荐使用软件下载。</h>
      								<br/>
      								<br/>
      								<br/>
                                 <a style="float:right;" href="Ziliaodownload?id=3">CHROME浏览器下载</a><br> 
                                 <a style="float:right;" href="Ziliaodownload?id=4"> 福昕PDF阅读器下载</a> 
