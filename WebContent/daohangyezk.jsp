    ...
    <body class="loaded"><header><h2>&nbsp;&nbsp;陕西省高等学校专业普查大数据系统</h2></header>
        <div id="widget_scroll_container" style="left: 59px;">
            <div class="widget_container half" >
             <h4>专科专业</h4>
                <div class="widget widget4x2 widget_darkred" onclick="window.open('zkzyxxup.jsp','_self')">
                ...
                <div class="widget widget2x2 widget_orange widget_link" onclick="window.open('zkzyxxrevise.jsp','_self')">
                    <div class="widget_content">
                ...
                <div class="widget widget2x2 widget_green" onclick="window.open('zkzyxxexport.jsp','_self')">
                    <div class="widget_content">
                ...
                <div class="widget widget4x2 widget_red widget_link" style="background-color:#00ACED;" onclick="window.open('zkzyxxdelete.jsp','_self')">
                    <div class="widget_content">
            ...
            <div class="widget_container half">
            <h4>其他功能</h4>
<!--             	<div class="widget widget4x2 widget_blue" onclick="window.open('zyxxupzkbu.jsp','_self')"> -->
<!--                     <div class="widget_content"> -->
