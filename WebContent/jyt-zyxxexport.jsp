	        ...
	        <div class="row">
		        <div class="col-lg-10 col-lg-offset-1">
		            ...
		            <div class="wizard-container">
		                 ...
		                 <form action="" method="" class="form-horizontal" >
		                  			<div class="form-group">
		                				<div class="group ">
				                            ...
				                            <div class="col-sm-3" >
				                                <select id='txt_xxxm'  OnChange="xymc()" class="form-control selectpicker"  data-live-search="true"></select>
				                            </div>
				                        </div>
		                    			<div class="group ">
		                		...
		                		<div class="form-group">
				                        <div class="group">
				                            <label class="col-sm-2 control-label">本科专业:</label>
				                            <div class="col-sm-5">
		                ...
		                <form action="Bkpdf" method="post" class="form-horizontal" id="forms">
		                <!--        You can switch " data-color="green" "  with one of the next bright colors: "bue", "azure", "orange", "red"       -->
		                    	...
		                    	<div class="wizard-header">
		                        	...
		                        	<h3 class="wizard-title">本科专业信息导出表</h3>
		                    	</div>
		                        ...
		                        <div class="tab-content">
		                            ...
		                            <div class="tab-pane " id="tab1">
	                         		  <div class="form-group">
				                        <div class="group ">
				                            <label class="col-sm-2  control-label">学校:</label>
				                            <div class="col-sm-3">
				                                <input  type="text" id="xxmc"  class="form-control" name="XXMC"   readonly />
				                            </div>
				                        </div>
				                        <div class="group" style="display: none;">
				                            <label class="col-sm-2 control-label">学校代码:</label>
				                            <div class="col-sm-3">
				                                <input  type="text" id="xxdm"  class="form-control" name="XXDM" />
				                            </div>
				                        </div>  
				                        <div class="group ">
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                                <input  type="text"   class="form-control" name="ZYCC" placeholder="本科" readonly/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">专业名称:</label>
				                            <div class="col-sm-5">
				                                <input  type="text" id="zymc"  class="form-control" name="ZYMC" readonly/>
				                            </div>
				                        </div>
				                        <div class="group" style="display: none;">
				                     ...
				                     <div class="form-group">
				                        ...
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                                <select  class="form-control"  data-live-search="true" name="SSDBZ" required  disabled>
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <select  class="form-control"  data-live-search="true" name="BSDBZ"  required  disabled>
										            <option disabled="" selected="">- 请选择 -</option>
										            <option value ="1">有</option>
													<option value ="0">无</option>
												</select>
				                    ...
				                    <div class="form-group">
				                     ...
				                     <div class="form-group">
				                        ...
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                                <input  type="text"     class="form-control" name="ZCRS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="ZRRS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">当年应届毕业生研究生录取人数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="YJSLQRS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                        <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="JSLXSRS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">当年学生出国（境）学习人数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""  class="form-control" name="SCLXSRS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <div class="input-group">
											      <input type="text"    value="" class="form-control" name="BYSCCJYL"  required disabled>
				                        ...
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                            	<div class="input-group">
											      <input type="text"    value="" class="form-control" name="BYSMYD" required disabled>
											      <div class="input-group-addon">%</div>
											    </div>
				                            </div>
				                        </div>      	
				                      ...
				                      <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""  class="form-control" name="ZZCYRS" required disabled/>
				                            </div>
				                        </div>
				                    </div>
		                        </div>
				                    ...
				                    <div class="form-group">
				                        ...
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="ZSZGF" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">当年在陕最低分:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="ZSZDF" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group" style="display: none;">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="ZSZGWC" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">当年在陕最低位次:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="ZSZDWC" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""    class="form-control" name="ZSPJF" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group" style="display: none;">
				                            <label class="col-sm-2 control-label">当年在陕招生平均位次:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="ZSPJWC" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="GJXKJSCJRS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年参加国家级学科竞赛获奖人次:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"     value=""   max="3000" class="form-control" name="GJXKJSDJS" data-toggle="tooltip" data-placement="top" title="不含互联网+大赛" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="SXXKJSCJRS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年省级学科竞赛获奖人数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   max="3000" class="form-control" name="SXXKJSDJS" data-toggle="tooltip" data-placement="top" title="不含互联网+大赛" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="SNGJHLWDJS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >上一年度学生参加互联网+大赛获省级奖人数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="SNSXHLWDJS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="GJDCS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年主持的省级大学生创新创业训练项目立项数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   class="form-control" name="SJDCS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                      <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   max="800" class="form-control" name="LWS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >本科生申请专利数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   max="300" class="form-control" name="ZLS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
		                               <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <div class="input-group">
											      <input type="text" class="form-control" name="SJTGL"   value=""   required disabled>
											      <div class="input-group-addon">%</div>
											    </div>
				                            </div>
				                        </div>
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                            	<div class="input-group">
											      <input type="text" class="form-control" name="LJTGL"   value=""  required disabled>
											      <div class="input-group-addon">%</div>
											    </div>
				                            </div>
				                        </div>      	
				                     ...
				                     <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value="" class="form-control" name="SJJLS"   max="2000"  data-toggle="tooltip" data-placement="top" title="不含学科竞赛获奖" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >在校生获得各级奖学金人数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value="" class="form-control" name="JXJS"   max="2000" data-toggle="tooltip" data-placement="top" title="不含助学金" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>  
<div class="form-group">
		                         ...
		                         <div class="tab-pane" id="tab3">
		                            <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   max="1000" class="form-control" name="JSZS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >正高职称教师数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   max="1000" class="form-control" name="ZGJSZS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value="" class="form-control"   max="1000" name="FGJSZS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >外聘教师数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value="" class="form-control"   max="200" name="WPJSZS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   max="500" class="form-control" name="YOUNGJSZS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >35岁（含）以下年龄教师数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   max="500" class="form-control" name="MEDIANJSZS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   max="1000" class="form-control" name="BSJSZS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >实验教师数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   max="100" class="form-control" name="SYJSZS" data-toggle="tooltip" data-placement="top" title="本专业教师中专业职实验教师人数" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
		                             <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   max="500" class="form-control" name="DNSKZGJSS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年教师参加各类国家级教学技能竞赛活动获奖人数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   max="500" class="form-control" name="DNGJJXJS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                         <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   max="100" class="form-control" name="GJJJXTDS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年参加各类省级教学技能竞赛活动获奖人数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   max="500" class="form-control" name="DNSJJXJS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
		                            ...
		                            <div class="tab-pane" id="tab4">
		                             <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   max="100" class="form-control" name="DNGJKJJS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年教师获得省级科技奖数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   max="100" class="form-control" name="DNSJKJJS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                      <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""   max="500" class="form-control" name="DNGJJXMS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年教师主持的省部级科研项目数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""   max="500" class="form-control" name="DNSBXMS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                     <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <div class="input-group">
											      <input type="text" class="form-control" name="DNZXDK" value="" required disabled>
				                        ...
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                            	<div class="input-group">
											      <input type="text" class="form-control" name="DNHXDK" value=""   required disabled>
											      <div class="input-group-addon">万元</div>
											    </div>
				                            </div>
				                        </div>      	
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""     class="form-control" name="GJJKYTDS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >省级教学团队:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""     class="form-control" name="SJJXTDS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""     class="form-control" name="SJKYTDS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年教师发表的SCI论文数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""      class="form-control" name="DNSCI" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                     <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""      class="form-control" name="DNSSCI" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年教师发表的CSSCI论文数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""      class="form-control" name="DNCSSCI" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""      class="form-control" name="DNEI" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年教师发表的CSCD论文数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""      class="form-control" name="DNCSCD" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""      class="form-control" name="DNISTP" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label" >当年教师获得的专利数:</label>
				                            <div class="col-sm-3">
				                                <input  type="text"   value=""      class="form-control" name="DNZLS" required disabled/>
				                            </div>
				                        </div>      	
				                    </div>
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""      class="form-control" name="DNRJZZQS" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
									...
									<div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"   value=""      class="form-control" name="DNCGFXS"  data-toggle="tooltip" data-placement="top" title="出国访问交流、学习、培训（不包含会议形式）" required disabled/>
				                            </div>
				                        </div>
				                    </div>
		                           </div>
		                             ...
		                             <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <div class="input-group">
											      <input type="text" class="form-control" name="ZSBF"   value=""    max="100000" required disabled>
											      <div class="input-group-addon">万元</div>
											    </div>
				                            </div>
				                        </div>
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                            	<div class="input-group">
											      <input type="text" class="form-control" name="ZRJF"   value=""     max="100000" required disabled>
											      <div class="input-group-addon">万元</div>
											    </div>
				                            </div>
				                        </div>      	
				                     ...
				                     <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <div class="input-group">
											      <input type="text" class="form-control" name="DNSBF"   value=""     max="100000" required disabled>
											      <div class="input-group-addon">万元</div>
											    </div>
				                            </div>
				                        </div>
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                            	<div class="input-group">
											      <input type="text" class="form-control" name="DNRJF"   value=""     max="100000" required disabled>
											      <div class="input-group-addon">万元</div>
											    </div>
				                            </div>
				                        </div>      	
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                             <input type="text" class="form-control" name="ZYTUSHU"  value="0"     data-toggle="tooltip" data-placement="top" title="含纸质、电子图书" required readonly>
				                        ...
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                            	<div class="input-group">
											      <input type="text" class="form-control" name="DNJXJF"   value=""     max="100000" placeholder="单位万元" required disabled>
											      <div class="input-group-addon">万元</div>
											    </div>
				                            </div>
				                        </div>      	
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <div class="input-group">
											      <input type="text" class="form-control" name="SJJXJF"   value=""       required disabled>
											      <div class="input-group-addon">万元</div>
											    </div>
				                            </div>
				                        </div>
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
											      <input   value=""     type="text" class="form-control" name="XNSXJD" required disabled>
				                            </div>
				                        </div>      	
				                    </div> 
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""     type="text" class="form-control" name="XWSXJD" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
											      <div class="input-group">
											      <input type="text" class="form-control" name="BYLWBL" value=""    required disabled>
											      <div class="input-group-addon">%</div>
											    </div>
				                            </div>
				                        </div>      	
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""     type="text" class="form-control" name="GJJJSZXS" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">省级实验教学示范中心数量:</label>
				                            <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="SJJXSXS" required disabled>
				                            </div>
				                        </div>      	
				                    </div> 
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="GJJXNZSS" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">省级虚拟仿真实验教学中心数量:</label>
				                            <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="SJXNZSS" required disabled>
				                            </div>
				                        </div>      	
				                    </div> 
				                     <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="XQLHPYXYS" required disabled>
				                            </div>
				                        </div>
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="GJJSYSS" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">省级实验室数量:</label>
				                            <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="SJSYSS" required disabled>
				                            </div>
				                        </div>      	
				                    </div> 
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input  value=""  type="text" class="form-control" name="BYXFZS" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">理论课学分总数:</label>
				                            <div class="col-sm-3">
											      <input  value="" type="text" class="form-control" name="LLXFZS" required disabled>
				                            </div>
				                        </div>      	
				                    </div> 
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input  value=""  type="text" class="form-control" name="SJKXFZS" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">选修课学分总数:</label>
				                            <div class="col-sm-3">
											      <input value="" type="text" class="form-control" name="XXKXFZS" required disabled>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input  value=""  type="text" class="form-control" name="CXXFZS" required disabled >
				                            </div>
				                        </div>
				                        <div class="group">
		                             ...
		                             <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="DNSJJXYJS" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">国家级精品课程数量:</label>
				                            <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="DNGJJJPKCS" data-toggle="tooltip" data-placement="top" title="视频公开课、资源共享课、慕课" required disabled>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="DNSJJPKCS" data-toggle="tooltip" data-placement="top" title="视频公开课、资源共享课、慕课" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">教师获得国家级教学成果奖累计数:</label>
				                            <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="DNSJJXCGJS" required disabled>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="SJRCPYSYCS" required disabled>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="DNJGLWS" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">当年教师以学校为第一单位，公开出版国家级规划教材:</label>
				                            <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="DNGJJJCS" required disabled>
				                            </div>
				                        </div>      	
				                    </div>
				                     <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="DNSJYXJCS" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">其他教材第一主编公开出版:</label>
				                            <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="DNQTJCS" required disabled>
				                            </div>
				                        </div>      	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="DNGJJJXCGJ" required disabled>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">当年省级教学成果奖:</label>
				                            <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="DNSJJJXCGJ" required disabled>
				                            </div>
				                        </div>      	
				                    </div>
		                            </div>
				                    ...
				                    <div class="form-group">
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="CYZDJSRS" data-toggle="tooltip" data-placement="top" title="统计专职与兼职双创导师人数" required disabled>
				                            </div>
				                        </div>
				          				<div class="group">
				                            <label class="col-sm-2 control-label">当年教师到企业进行3个月以上挂职锻炼的人数:</label>
				                           <div class="col-sm-3">
											      <input   value=""    type="text" class="form-control" name="GZRS" required disabled>
				                            </div>
				                        </div>
				                    </div>
		                             ...
		                             <div class="tab-pane" id="tab8">
				                        ...
				                        <div class="group">
				                           ...
				                           <div class="col-sm-3">
				                                <input  type="text"  value="" class="form-control" name="JXJDPJ" data-toggle="tooltip" data-placement="top" title="百分制" required disabled/>
				                            </div>
				                        </div>
				                        <div class="group">
	...
	<script src="js/jyt-zyxxexport.js" type="text/javascript"></script>
