		                        ...
		                        <div class="tab-content">
		                            ...
		                            <div class="tab-pane " id="tab1">
				                        ...
				                        <div class="group ">
				                            ...
				                            <div class="col-sm-3">
				                                <input  type="text"   id="xymc" class="form-control" name="XYMC"  value="${user.xyxm}" readonly/>
				                            </div>
				                        </div> 
				                          <div class="group" style="display: none;">
				                            <label class="col-sm-2 control-label">学院代码:</label>
				                            <div class="col-sm-3">
				                                <input  type="text" id="xydm"  class="form-control"   value="${user.xydm}" name="XYDM" />
				                            </div>
				                        </div>        	
				                    </div>
				                    <div class="form-group">
				                        <div class="group">
				                            ...
				                            <div class="col-sm-3">
				                                <input  type="text"   class="form-control" name="3" placeholder="本科" readonly/>
				                            </div>
				                        </div>
				                        <div class="group">
				                            <label class="col-sm-2 control-label">专业名称:</label>
				                            <div class="col-sm-5">
				                                <input  type="text"   id="zymc"  class="form-control" name="ZYMC" value="${user.zymc}" readonly/>
				                            </div>
				                        </div> 
				                         <div class="group" style="display: none;">
				                            <label class="col-sm-2 control-label">专业代码:</label>
				                            <div class="col-sm-3">
				                                <input  type="text" id="zydm"  class="form-control"  name="ZYDM" value="${user.zydm}" />
				                            </div>
				                        </div>        	
				                    </div>
				                    <div class="form-group">
...
<div class="form-group">
	...
	<script src="js/zyxxexport.js" type="text/javascript"></script>
