		               ...
		               <div class="form-group">
		                ...
		                <!--        You can switch " data-color="green" "  with one of the next bright colors: "bue", "azure", "orange", "red"       -->
		                    	...
		                    	<div class="wizard-header">
		                        	...
		                        	<h3 class="wizard-title">本科专业信息删除表</h3>
		                    	</div>
...
<div class="form-group">
		                        ...
		                        <div class="wizard-footer">
	                            	<div class="pull-right">
	                                    ...
	                                    <input type='button' id="finish" class='btn btn-finish btn-fill btn-primary btn-wd' name='finish' value='删除' />
	...
	<script src="js/xy-zyxxdelete.js" type="text/javascript"></script>
